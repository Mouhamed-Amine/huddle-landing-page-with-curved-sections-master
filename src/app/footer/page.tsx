...
export default function Footer() {
    return (
        <>
            ...
            <section className="flex flex-col justify-center items-center mb-28 bg-white">
                <h1 className={`${style.family_headline} text-xl sm:text-2xl md:text-2xl lg:text-3xl xl:text-3xl mb-6 sm:mb-8 md:mb-10`} >
            ...
            {/* Footer with Wave Background and Dark Footer Content */}
            <footer className="relative bg-white w-full">
                {/* Wave Background Image */}

                {/* Dark Footer Content */}
                <div className="bg-slate-800 text-white flex flex-col md:flex-row justify-evenly items-start py-16 md:py-28">
                ...
                <img src="/images/bg-section-bottom-desktop-1.svg" alt="footer-wave" className="absolute inset-x-0 bg-slate-800 top-0 w-full h-15 object-cover" />
